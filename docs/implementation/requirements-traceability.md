...
| PingPong external validation | Roadmap Sec. 27-28 | PingPong | — | `DatasetSource.PINGPONG` | `datasets/pingpong/dataset.py` | `doctor` | none yet | presence check only; polarity blocker (see decisions-and-blockers.md) |
...
| CIC IoT 2022 optional real-attack | Roadmap Sec. 33 | cic-iot-2022 | — | `DatasetSource.CIC_IOT_2022` | `datasets/cic_iot_2022/dataset.py` | `doctor` | none yet | presence check only; adapter not built |
